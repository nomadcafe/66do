...
const en = {
  ...
  reports: {
    ...
    topPerformersNoProfit: 'No profitable sales yet — see the worst sale below.',
  ...
  settings: {
    ...
    dashboard: {
      ...
      briefingReceiptsDueTitle: 'Installment due',
      briefingReceiptsDuePrimaryOne: '{domain} — period {paid} of {total} due',
      briefingReceiptsDuePrimaryMany: '{count} installments due this week',
      briefingReceiptsDueSecondary: 'Expecting {amount} on {date}',
      briefingReceiptsDueSecondaryNearest: 'Nearest due {date}',
      briefingReceiptsDueNone: 'No installments due this week',
      ...
      tagsLabel: 'Tags',
      renewalCycleHelp: 'How many years one renewal covers. Renewal cost below is the price of one such renewal, not a yearly figure.',
    ...
    validation: {
      domain: {
        ...
        nameInvalidFormat: 'Invalid domain name format',
        registrarMustBeString: 'Registrar must be a string',
        registrarTooLong: 'Registrar cannot exceed 100 characters',
        purchaseDateInvalid: 'Invalid purchase date format',
        purchaseDateBeyondMaxFuture: 'Purchase date cannot be more than 10 years in the future',
        purchaseCostInvalidNumber: 'Purchase cost must be a valid number',
        purchaseCostNonNegative: 'Purchase cost must be non-negative',
        purchaseCostExceedsMax: 'Purchase cost cannot exceed $10,000,000',
        renewalCostInvalidNumber: 'Renewal cost must be a valid number',
        renewalCostNonNegative: 'Renewal cost must be non-negative',
        renewalCostExceedsMax: 'Renewal cost cannot exceed $1,000,000',
        renewalCycleMustBeInteger: 'Renewal cycle must be a whole number',
        renewalCyclePositive: 'Renewal cycle must be greater than 0',
        renewalCycleExceedsMax: 'Renewal cycle cannot exceed 10 years',
        renewalCountMustBeInteger: 'Renewal count must be a whole number',
        ...
        nextRenewalDateInvalid: 'Invalid next renewal date format',
        nextRenewalDateBeyondMaxFuture: 'Next renewal date cannot be more than 10 years in the future',
        ...
        statusRequired: 'Domain status is required',
        statusInvalid: 'Invalid domain status',
        estimatedValueInvalidNumber: 'Estimated value must be a valid number',
        estimatedValueNonNegative: 'Estimated value must be non-negative',
        estimatedValueExceedsMax: 'Estimated value cannot exceed $100,000,000',
        expiryBeforePurchase: 'Expiry date cannot be earlier than the purchase date',
        saleBeforePurchase: 'Sale date cannot be earlier than the purchase date',
        tagsTooMany: 'Cannot have more than 20 tags',
    ...
    renewal: {
      ...
      renewalSpend: 'Renewal Spend',
      domainsRenewed: 'Domains Renewed',
      alreadySpent: 'Already Spent',
      spentRatio: '{percent}% of the year\u2019s estimate',
      remainingCost: 'Still to Come',
      ...
      averageCostChange: 'Average Cost Change',
      trendSampleSize: 'across {count} domain(s) with 2+ logged renewals',
      trendNoSample: 'Needs 2+ logged renewals on a domain to compare prices',
      ...
      upcomingDesc: 'Everything due in the next {days} days, soonest first.',
      upcomingNone: 'Nothing due in the next {days} days.',
      bucketOverdue: 'Overdue',
      bucket30: 'Next 30 days',
      bucket60: '31\u201360 days',
      bucket90: '61\u201390 days',
      bucketDomainCount: '{count} domain(s)',
      colDomain: 'Domain',
      ...
      dueToday: 'today',
      dueInDays: 'in {days}d',
      overdueByDays: '{days}d overdue',
      expiryEstimated: 'estimated',
      costUnknownHint: 'No renewal cost set for this domain',
      showAllRows: 'Show {count} more',
      showFewerRows: 'Show fewer',
      upcomingUnknownCost: '{count} of these have no renewal cost set, so the totals above are low.',
      upcomingUnknownExpiry: '{count} active domain(s) have no usable expiry date and are missing from this list entirely.',
      noRenewalInYear: 'No renewals recorded or forecast for {year}.',
      coverageWarning: '{count} of {total} active domains are not included in this forecast.',
      coverageMissingCost: '{count} missing a renewal cost',
      coverageMissingExpiry: '{count} missing an expiry date',
      coverageHint: 'Fill those fields in on the domain record and they will be counted here.',
      noRenewalData: 'No renewal data',
      noRenewalDataDesc: 'No active domains, or no renewal activity in this window'
    },
    transaction: {
      ...
      paidPeriodsReadonlyHint: 'Read-only — record each receipt with the "+ Receipt" button on the transaction list.',
      installmentStatus: 'Installment Status',
      installmentFirstPaymentDate: 'First Payment Date',
      installmentFirstPaymentDateHint: 'Optional. Seeds the suggested date when adding the first receipt.',
      addReceipt: '+ Receipt',
      receiptDate: 'Received Date',
      receiptAmount: 'Amount',
      receiptPeriodNo: 'Period No.',
      receiptNotes: 'Notes',
      receiptsList: 'Receipts',
      refundHint: 'Enter a negative amount to record a refund.',
      receiptAddFailed: 'Failed to add receipt.',
      receiptUpdateFailed: 'Failed to update receipt.',
      receiptDeleteFailed: 'Failed to delete receipt.',
      noReceipts: 'No receipts recorded yet.',
      editingReceipt: 'Editing an existing receipt',
      switchToAddReceipt: 'Add a new one instead',
      confirmDeleteReceipt: 'Delete this receipt? This cannot be undone.',
      ...
      renewalCycleHelp: 'How many years one renewal covers. Renewal cost is the price of one such renewal, not a yearly figure.',
      renewalCountLabel: 'Renewal count',
    ...
    domainList: {
      ...
      table: {
        ...
        clickToUpdateRenewalCost: 'Click to set the cost of one renewal',
        costNotSet: 'Set',
        costLabelBuy: 'Buy',
    ...
    analytics: {
      ...
      cumulativeRenewalCost: 'Cumulative renewals (part of investment)',
      cumulativeSales: 'Cumulative sales',
      portfolioPerformanceDesc: 'All four lines are running totals over the selected window, so they share a scale and can be read against each other: what went in, what came back, and what of that is actually realized. Renewals are the slice of investment spent on renewing rather than buying, so that line always sits under the investment area. Month-by-month detail is in the net cash flow chart below.',
