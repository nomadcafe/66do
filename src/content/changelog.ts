  ...
  zh: [
    {
      ...
      date: '2026-09-13',
      items: [
        '修复金额输入框吃掉小数的问题：以前 $10.05 会存成 $5，0.15 这类费率根本填不进去。',
        '修复多年期域名（2 年一续等）的续费单价：每续费一次存档单价就被砍半，持有成本一路缩水、利润虚高。',
    ...
    },
    {
      ...
      date: '2026-08-25',
      items: [
        '转移费和手工记的买入交易现在计入域名成本。',
        '修复续费成本被重复计算的问题。',
        '老域名手工记的续费金额现在生效。',
        '统一各处支出口径，成本与 ROI 的数字会随之调整。',
        'Transfer 交易可以记录延长的到期年数，金额也可以填 0。',
      ],
    },
    {
      version: '2026-08-10',
  ...
  en: [
    {
      ...
      date: '2026-09-13',
      items: [
        'Fixed amount fields swallowing decimals — $10.05 used to save as $5, and rates like 0.15 could not be typed at all.',
        'Fixed the renewal price on multi-year domains (2-year cycles and similar): each renewal halved the stored price, shrinking holding cost and inflating profit.',
    ...
    },
    {
      ...
      date: '2026-08-25',
      items: [
        'Transfer fees and manually recorded purchases now count toward domain cost.',
        'Fixed renewal cost being counted twice.',
        'Renewal amounts recorded on older domains now take effect.',
        'Unified how spend is counted — cost and ROI figures will shift accordingly.',
        'Transfer transactions can record years added to expiry, and the amount can be 0.',
      ],
    },
    {
      version: '2026-08-10',
