...
const translations: Record<Locale, Translations> = {
  ...
  settings: {
    ...
    analytics: {
      ...
      sharpeRatio: '夏普比率',
      sharpeRatioDesc: '夏普比率：衡量每承担一单位风险所获得的超额回报。数值越高，风险调整后的收益越好（通常>1为良好）',
  ...
  settings: {
    ...
    analytics: {
      ...
      sharpeRatioDesc: 'Sharpe Ratio: Measures excess return per unit of risk. Higher is better (typically >1 is good)',
