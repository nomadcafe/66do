...
const translations: Record<Locale, Translations> = {
  ...
  reports: {
    ...
    rec: {
      ...
      longHolding: '平均持有期偏长（超过 5 年），可考虑更主动的出手节奏。',
  ...
  settings: {
    ...
    validation: {
      transaction: {
        ...
        exchangeRateInvalid: '汇率必须是有效数字',
        exchangeRateOutOfRange: '汇率必须在 0.0001 和 1000 之间',
    ...
    transaction: {
      ...
      platformPlaceholder: 'GoDaddy、Namecheap 等',
  ...
  reports: {
    ...
    rec: {
      ...
      longHolding: 'Average holding period is over 5 years — consider a more active exit cadence.',
  ...
  settings: {
    ...
    validation: {
      transaction: {
        ...
        exchangeRateOutOfRange: 'Exchange rate must be between 0.0001 and 1000',
    ...
    transaction: {
      ...
      platformPlaceholder: 'GoDaddy, Namecheap, etc.',
